// ==================== AGRI CONNECT X - BUYER DASHBOARD (Final) ====================
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-image">
                    <img src="https://picsum.photos/600/400?random=${productId}" alt="Product Image">
                </div>
                <div class="modal-info">
                    <h2>Product Details</h2>
                    <p><strong>Price:</strong> <span id="modalPrice">Loading...</span></p>
                    <p><strong>Available:</strong> <span id="modalStock">Loading...</span></p>
                    ...
                    <button class="btn-cart big" onclick="addCurrentProductToCart('${productId}')">Add to Cart</button>
                </div>
            </div>
        </div>
    `;
...
function addCurrentProductToCart(productId) {
    addToCart(productId, "Selected Product", 500); // placeholder - in real app fetch real price
...
function showCart() {
    ...
    let html = `<h2>Your Cart (${cart.length} items)</h2>`;
    ...
    html += `<h3>Total: ${total} FCFA</h3><button onclick="checkout()" class="btn-cart big">Checkout</button>`;
...
function checkout() {
    alert("🎉 Thank you! Your order has been placed.\n\nFull checkout system coming soon.");
    cart = [];
    updateCartCount();
    document.querySelectorAll('.modal').forEach(m => m.remove());
}
